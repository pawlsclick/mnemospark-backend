...
| `CDP_API_KEY_SECRET` | `CdpX402FacilitatorBearerToken` | CDP x402 facilitator **Secret API Key** used to call `https://api.cdp.coinbase.com/platform/v2/x402` (`/verify`, `/settle`). |
