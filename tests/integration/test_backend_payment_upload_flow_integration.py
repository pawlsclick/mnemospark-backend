...
class BackendFlowIntegrationTests(unittest.TestCase):
    def setUp(self):
        ...
        self.patches = [
            ...
            mock.patch.object(ls_app.boto3, "client", return_value=self.s3_client),
            mock.patch.object(download_app.boto3, "client", return_value=self.s3_client),
            mock.patch.object(delete_app.boto3, "client", return_value=self.s3_client),
